...
export default function MarkdownContent({content}: MarkdownContentProps) {
    return (
        ...
        prose-a:text-blue-600 dark:prose-a:text-blue-400 prose-a:underline prose-a:decoration-2 prose-a:decoration-blue-400/50 prose-a:underline-offset-2 prose-a:transition-colors prose-a:duration-200 prose-a:hover:text-blue-700 dark:prose-a:hover:text-blue-300 prose-headings:prose-a:no-underline
